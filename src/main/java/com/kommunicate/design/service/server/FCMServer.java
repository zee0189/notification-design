...
@Service
public class FCMServer extends NotificationExecutor {

    public static final String TYPE = "FCM_SERVER";
    ...
    protected void triggerNotification(NotificationRequest notificationRequest) {
        System.out.println("Triggering notification through FCM server.");
    }
}

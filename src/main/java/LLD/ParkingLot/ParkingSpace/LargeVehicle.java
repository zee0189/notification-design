...
@Data
public class LargeVehicle implements ParkingSpace{

    private static final int DEFAULT_PRICE = 80;
    private static final String TYPE = "LARGE_VEHICLE";

    private int id;
    private boolean isFree;


    public LargeVehicle(int id) {
        this.id = id;
        this.isFree = true;
    }
